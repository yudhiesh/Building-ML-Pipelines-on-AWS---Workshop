...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://creditmodel-yudhiesh-mlsandbox-867352166187-us-east-1/data-wrangler/credit-flow-2021-03-25-08-14-10/e61491fa-5fc6-4761-a5f2-4175fdc3ac72/default/",  # Change this to point to the s3 location of your raw input data.
    )
